  ...
  <div class="achievement-notification-container">
    <TransitionGroup name="achievement-list">
      <div
        ...
        :class="`rarity-${notification.rarity}`"
      ...
      >
        ...
        <div class="notification-content">
          <div class="notification-badge">🏆 成就解锁</div>
...
const visibleNotifications = computed(() => {
  return gameStore.achievementNotification?.visible ? [gameStore.achievementNotification] : []
})
...
.achievement-notification.rarity-common { border-color: #6b7280; }
